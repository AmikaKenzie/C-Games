...
namespace Tic_Tac_Toe
{
    ...
    {
        //making array and   
        //by default I am providing 0-9 where there is no no use of zero  
        ...
        static void Main(string[] args)
        {
            ...
            else// if flag value is -1 the match will be a draw and no one is winner  
            {
        ...
        private static int CheckWin() //calling the check of a win
        {
